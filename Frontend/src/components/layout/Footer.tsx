    ...
    <footer className="bg-gray-100 border-t mt-auto">
      <div className="container max-w-6xl mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="font-bold text-lg mb-4">EventMaster</h3>
            <p className="text-muted-foreground">
              Discover and book amazing events in your area. From music festivals to tech conferences, we've got you covered.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="/" className="text-sm text-muted-foreground hover:text-primary">All Events</Link></li>
              <li><Link to="/" className="text-sm text-muted-foreground hover:text-primary">Categories</Link></li>
              <li><Link to="/" className="text-sm text-muted-foreground hover:text-primary">Venues</Link></li>
              <li><Link to="/" className="text-sm text-muted-foreground hover:text-primary">Featured Events</Link></li>
            </ul>
          </div>
